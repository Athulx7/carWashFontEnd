          ...
          <Row>
            <Col>
              ...
              <p>
                ...
                sapiente mollitia voluptas! Doloribus quas, deserunt temporibus
                ...
                consectetur adipisicing elit. Qui vel eaque aperiam deleniti,
                iste quibusdam numquam porro laboriosam sint, natus aspernatur
                facere. Ducimus cupiditate deserunt velit minus molestiae
                molestias optio.
              </p>
            </Col>
            <Col>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              ...
              <div className="mt-3 text-center">
                <p className="fw-bold">Click Your Rating</p>
                {[...Array(5)].map((_, index) => (
                  <button
                    key={index}
                  ...
                  >
                    <FontAwesomeIcon
                      icon={index < webreviewstar ? faStar : faStarRegular}

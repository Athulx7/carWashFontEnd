...
function Footer() {
  return (
    <>
      ...
      > */}
      <div
        className="d-flex p-5 d-flex justify-content-center align-items-center mt-5 "
      ...
      >
        <div className="" style={{ width: "300px" }}>
          ...
          <p style={{ textAlign: "justify", color: "gray" }} className="mt-4">
        ...
        <div
          className="d-flex flex-column ms-5 link"
          style={{ width: "300px" }}
        >
          <h5>Links</h5>
        ...
        <div
          className="d-flex flex-column ms-4 link"
          style={{ width: "300px" }}
        >
          <h5>Send Message</h5>
        ...
        >
          ...
          <div className="d-flex flex-row mt-3 ">
            ...
            <Link
              className="lnk ms-3 text-primary"
            ...
            <Link
              className="lnk "
              style={{ textDecoration: "none", color: "#fd02b3" }}
            >
